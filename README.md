...
|--------|-------------|-------|
| [`2FA-Example/`](./2FA-Example/) | SMS two-factor authentication login | NestJS + HTML/CSS/JS |
...
|---------|-------------|-------|
| [`2FA-Example/`](./2FA-Example/) | Connexion avec authentification à deux facteurs par SMS | NestJS + HTML/CSS/JS |
